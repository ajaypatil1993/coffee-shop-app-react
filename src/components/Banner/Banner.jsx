          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div data-aos="zoom-in">
              <img
                src={BannerImg}
                alt=""
                className="max-w-[430px] w-full mx-auto spin drop-shadow-[10px_10px_12px_rgba(0,0,0,0.2)]"
              />
            </div>
            {/* Text Section */}
            <div className="flex flex-col justify-center gap-6 sm:pt-0">
              <h1 
              data-aos="fade-up"
              className="text-3xl sm:text-4xl lg:text-4xl font-bold font-cursive">
              ...
              className="text-sm text-gray-500 tracking-wide leading-5">
                ...
                Corporis, earum quidem ullam dignissimos nemo aut odit quibusdam
                eaque. 
              </p>
